...
class Zona {
    ...
    Zona(int idZona, int nZonas, ArrayList<Camion> camionesEnEspera, ArrayList<Double> probabilidad_destinos, Estadistica est, double media_generacion_paquetes, double desvTip_generacion_paquetes, double media_tam, double desvTip_tam, double media_tiempo_limite, double desvTip_tiempo_limite, int max_tiempo_limite) {
        
        this.idZona = idZona;
        this.nZonas = nZonas;
        this.camiones_espera = camionesEnEspera;
    ...
    int generacion_paquetes() {
        ...
        int nPaq = (int) Math.round(est.getNormal(media_generacion_paquetes, media_generacion_paquetes));
        int origen = idZona;
        int destino;
        double tamaño;
        int dia_limite;
        ...
        for (int i = 0; i < nPaq; i++) {
            ...
            //calculo dia limite 
            dia_limite = (int) Math.round(est.getNormal(media_tiempo_limite, desvTip_tiempo_limite));
